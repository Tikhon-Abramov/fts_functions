...
import { Box, Button, CircularProgress, IconButton, Paper, Tooltip, Typography, useTheme } from "@mui/material";
import { AttachFile, Close, Download, InsertDriveFileOutlined, UploadFile } from "@mui/icons-material";
...
export type FileAttachmentInputProps = {
  ...
  /** Режим просмотра: скрывает кнопки прикрепления/замены и очистки, оставляя только скачивание. */
  readOnly?: boolean;
        ...
        >
          ...
          >
            {isDownloading ? (
              ...
              <AttachFile
                sx={{ fontSize: 18, color: c.textMuted, flexShrink: 0 }}
              />
            )}
