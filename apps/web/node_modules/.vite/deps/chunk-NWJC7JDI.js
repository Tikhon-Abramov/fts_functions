// ../../node_modules/.pnpm/@mui+x-data-grid@9.0.2_@emotion+react@11.14.0_@types+react@18.3.28_react@18.3.1__@emoti_e66c713b9bdab993d3abd78e15c10925/node_modules/@mui/x-data-grid/utils/getGridLocalization.mjs
...
var buildLocaleFormat = (locale) => {
  return (value) => formatNumber(value, locale);
};

// ../../node_modules/.pnpm/@mui+x-data-grid@9.0.2_@emotion+react@11.14.0_@types+react@18.3.28_react@18.3.1__@emoti_e66c713b9bdab993d3abd78e15c10925/node_modules/@mui/x-data-grid/constants/localeTextConstants.mjs
var formatNumber2 = buildLocaleFormat("en-US");
var GRID_DEFAULT_LOCALE_TEXT = {
  ...
  paginationDisplayedRows: ({
    ...
    if (!estimated) {
      return `${formatNumber2(from)}–${formatNumber2(to)} of ${!unknownRowCount ? formatNumber2(count) : `more than ${formatNumber2(to)}`}`;
    }
    const estimatedLabel = estimated && estimated > to ? `around ${formatNumber2(estimated)}` : `more than ${formatNumber2(to)}`;
    return `${formatNumber2(from)}–${formatNumber2(to)} of ${!unknownRowCount ? formatNumber2(count) : estimatedLabel}`;
  },
...
//# sourceMappingURL=chunk-NWJC7JDI.js.map
