...
export default function FunctionFormPanel({
  ...
  const availableFunctionNames = useMemo(() => {
    ...
    return all.filter((type) => !takenNameIds.has(type.id));
  ...
  const handleCreated = useCallback(
      ...
      [onCreated, expanded, onToggleExpanded],
  );
  ...
  const handleToggleExpanded = useCallback(() => {
    ...
    onToggleExpanded();
  }, [expanded, isDirty, onToggleExpanded]);
  ...
  }, [isDirty, reset, onCancelEdit, expanded, onToggleExpanded]);
